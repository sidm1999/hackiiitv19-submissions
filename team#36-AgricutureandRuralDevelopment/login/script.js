$(document).ready(function(){
  ...
  var config = {
      apiKey: "AIzaSyDw2z9r7HEed7-vh7yQhd-HLx0U0j7xxys",
      authDomain: "hackiiitv-52de7.firebaseapp.com",
      databaseURL: "https://hackiiitv-52de7.firebaseio.com",
      projectId: "hackiiitv-52de7",
      storageBucket: "hackiiitv-52de7.appspot.com",
      messagingSenderId: "700671830811",
      appId: "1:700671830811:web:f7dc54045685c536f101be",
      measurementId: "G-1JK14D5QCC"
  ...
  $('#registerForm').on('submit', function (e) {
    ...
    var data = {
      ...
      name: $('#registerFirstName').val(), // get firstName
      phone_no: $('#registerPhone').val(),
      lname: $('#registerLastName').val(), // get lastName
    };
    var passwords = {
    ...
    if (user) {
      ...
      usersRef.child(user.uid).once('value').then(function (data) {
        ...
        if(user.photoUrl) {
          ...
          $('.user-info img').hide();
          $('.user-info').append('<span class="user-name">'+info.name+'</span>');
        }
      });
